...
- Name: smoke.spec.ts >> Smoke Tests [UE-63] @smoke >> should load the application @smoke
- Location: tests\e2e\smoke.spec.ts:5:3
...
- generic [ref=e3]:
  - generic [ref=e6]:
    - heading "Esta página não está funcionando" [level=1] [ref=e7]
    - paragraph [ref=e8]:
      - text: Nenhum dado foi enviado por
      - strong [ref=e9]: localhost
    - generic [ref=e10]: ERR_EMPTY_RESPONSE
  - button "Recarregar" [ref=e13] [cursor=pointer]
```
